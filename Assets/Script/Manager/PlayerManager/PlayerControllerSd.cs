...
public class PlayerControllerSd : Controller
{
	...
	protected new void OnEnable()
	{
		...
		// AttackDownEvent
		MoboControllerSd.AttackDownEvent += new MoboControllerSd.AttackDownEventHandler(AttackDownEventFunc);
		// AttackUpEvent
		MoboControllerSd.AttackUpEvent += new MoboControllerSd.AttackUpEventHandler(AttackUpEventFunc);
